...
using { avijeet.db.master , avijeet.db.transaction } from './datamodel.cds';
context CDSViews {
    ...
    select from master.product as prod{
        ...
        ) as ![PO_SUM]: Decimal(15,2) // Specify the type of PO_SUM here
    };
    ...
    define view CProductValuesView as 
        select from ProductView{
            ...
            SUM(PO_ORDERS.GrossAmount)  as ![POGrossAmount] : Decimal(15,2) // Specify the type of PO_SUM here
        }
